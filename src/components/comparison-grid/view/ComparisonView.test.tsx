...
// jsdom はレイアウトを持たず、素のままでは仮想化された本体行 / 列が 1 本も描画されません。
//   spreadsheet-grid 0.29.0 の公式スタブ(/testing サブパス。提案 #3 採用)で
//   clientHeight / clientWidth / getBoundingClientRect / observe 時に即時発火する
//   ResizeObserver / scrollTo をまとめて入れ、実グリッドに行 / セルを描画させて
//   ハイライトの配線を DOM で検証します(既定 1200×600 = 旧自前スタブと同寸法)。
beforeAll(() => {
