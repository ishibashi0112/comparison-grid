...
/** GridColumn.cellClassName(関数版)が受け取るコンテキストです。spreadsheet-grid 0.29.0 で
 *  CellStyleContext がバレル公開されたため、再エクスポートに置き換えました(提案 #1 採用。
 *  導出型 Parameters<...>[0] と同一 shape のため利用側は無変更)。 */
