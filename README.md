...
Peer dependencies: **react** / **react-dom** `>= 19` and **@ishibashi0112/spreadsheet-grid** `>= 0.28.1 < 1`.
...
peer dependencies: **react** / **react-dom** `>= 19`、**@ishibashi0112/spreadsheet-grid** `>= 0.28.1 < 1`。
