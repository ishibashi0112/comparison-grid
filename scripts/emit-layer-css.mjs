// dist/style.layer.css を生成します(spreadsheet-grid の THEME-1 と同じ二本立て)。
// 目的: Tailwind v4 などカスケードレイヤーを運用する利用側向けに、全スタイルを
//   `@layer cmpg-base` へ入れたバリアントを提供します。実体は 1 行の @import layer() で、
...
writeFileSync(
  ...
  '@import url("./style.css") layer(cmpg-base);\n',
);
